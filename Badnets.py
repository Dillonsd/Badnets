  ...
  compression_tasks = [
    [CompressionTask(Quantization,
     ...
     CompressionTask(Clustering,
                     model=Model('MNIST - Baseline Clustered',
                       'mnist/badnets_baseline_clustered.tflite'),
                     optimizer='adam',
                     loss='categorical_crossentropy',
                     metrics=['accuracy'],
                     batch_size=32,
    ...
    [CompressionTask(Quantization,
     ...
     CompressionTask(Pruning,
                     ...
                     verbosity=1),
     CompressionTask(Clustering,
                     model=Model('MNIST - Single pixel all to all Clustered',
                       'mnist/badnets_single_pixel_all_to_all_clustered.tflite'),
                     optimizer='adam',
                     loss='categorical_crossentropy',
                     metrics=['accuracy'],
                     batch_size=32,
    ...
    [CompressionTask(Quantization,
     ...
     CompressionTask(Pruning,
                     ...
                     verbosity=1),
     CompressionTask(Clustering,
                     model=Model('MNIST - Single pixel all to one Clustered',
                       'mnist/badnets_single_pixel_all_to_one_clustered.tflite'),
                     optimizer='adam',
                     loss='categorical_crossentropy',
                     metrics=['accuracy'],
                     batch_size=32,
    ...
    [CompressionTask(Quantization,
     ...
     CompressionTask(Pruning,
                     ...
                     verbosity=1),
     CompressionTask(Clustering,
                     model=Model('MNIST - Trigger pattern all to all Clustered',
                       'mnist/badnets_trigger_all_to_all_clustered.tflite'),
                     optimizer='adam',
                     loss='categorical_crossentropy',
                     metrics=['accuracy'],
                     batch_size=32,
    ...
    [CompressionTask(Quantization,
     ...
     CompressionTask(Pruning,
                     ...
                     verbosity=1),
     CompressionTask(Clustering,
                     model=Model('MNIST - Trigger pattern all to one Clustered',
                       'mnist/badnets_trigger_all_to_one_clustered.tflite'),
                     optimizer='adam',
                     loss='categorical_crossentropy',
                     metrics=['accuracy'],
                     batch_size=32,
